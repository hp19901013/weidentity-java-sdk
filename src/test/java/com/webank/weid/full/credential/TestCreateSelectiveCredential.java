...
public class TestCreateSelectiveCredential extends TestBaseServcie {
    ...
    private Credential copyCredential(Credential credential) {
        ...
        newCredential.setExpirationDate(credential.getExpirationDate());
        newCredential.setIssuer(credential.getIssuer());
        newCredential.setIssuranceDate(credential.getIssuranceDate());
        newCredential.setContext(credential.getContext());
        newCredential.setId(credential.getId());
        newCredential.setSignature(credential.getSignature());
        newCredential.setCptId(credential.getCptId());
        newCredential.setClaim(credential.getClaim());
